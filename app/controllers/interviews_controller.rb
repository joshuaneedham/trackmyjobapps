class InterviewsController < ApplicationController
  ...
  def interview_params
    params.require(:interview).permit(:interview_type, :interview_date, :interview_time, :interview_duration, :interview_location, :interview_description, :job_id).merge(user_id: current_user.id)
  end
end
